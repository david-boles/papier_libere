    ...
    return (
      <div style={{padding: 20}}>
        ...
        <Grid container direction='column' justify='flex-start' alignItems='center' spacing={40}>
          ...
          <Grid item xs={10} s={9} md={8} lg={7} xl={6}>
            <Card>
              <img src="/scanned.png" style={{width: 'auto', maxWidth: '100%', maxHeight: '50vh'}}/>
              <CardActions>
          ...
          <Grid item xs={10} s={9} md={8} lg={7} xl={6}>
            <Card>
              <img src="/landscape.jpg" style={{width: 'auto', maxWidth: '100%', maxHeight: '50vh'}}/>
              <CardActions>
                <Button color="primary">
                  Override Detection
                </Button>
          ...
          <Grid item xs={10} s={9} md={8} lg={7} xl={6}>
            <Card>
              <img src="/small.png" style={{width: 'auto', maxWidth: '100%', maxHeight: '50vh'}}/>
              <CardActions>
                <Button color="primary">
                  Override Detection
                </Button>
