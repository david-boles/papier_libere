...
pages.pipe(fs.createWriteStream('./notebook_pages-uncropped.pdf'));
...
function contentPage(index) {
  ...
  pages.fillColor(pageNumColor).text(index, (bindingLeft ? 0.5 : 0.375)*PPI - 3 + (0.18*PPI), (10.75*PPI) - (PPI/3) - (0.13*PPI));
}